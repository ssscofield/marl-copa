...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
                 ...
                 done_callback=None, post_step_callback=None, shared_viewer=True):
    ...
    def get_attributes(self):
        return self.world.agent_attributes

    def get_entities(self):
        return self.world.other_entities
    ...
    def _reset_render(self):
        ...
        self.render_range_geoms = None
        self.render_range_geoms_xform = None
    ...
    def render(self, mode='human'):
        ...
        if self.render_geoms is None:
            ...
            for entity in self.world.entities:
                ...
                if 'agent' in entity.name:
                    range_geom = rendering.make_circle(self.world.observable_range)
        ...
        for i in range(len(self.viewers)):
            ...
            for a, agent in enumerate(self.world.agents):
                if agent.alive:
                    self.render_range_geoms_xform[a].set_translation(*agent.state.p_pos)
                    self.render_range_geoms[a].set_color(1,1,1, alpha=0.6)
                else:
                    self.render_range_geoms[a].set_color(0.1,0.1,0.1, alpha=0)
